    ...
    public function up(): void
    {
        ...
        DB::transaction(function () use ($sucursalId) {
            $cajaBase = DB::table('cajas')
                ...
                ->where('monto_apertura', 1464.25)
                ->where('monto_cierre', 2940.50)
                ->where('total_sistema', 1646.25)
                ->first();
